...
const ModalImage = ({ toggle, setToggle, clickedPhoto }) => {
    ...
    return (
        <>
            {
                toggle ? 
                    <div className={ `position-fixed ${ style.bgDark50 } w-100 vh-100 d-flex justify-content-center  align-items-center top-0` } style={{zIndex: 10}}>        
